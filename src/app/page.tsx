  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="grid justify-items-center">
        <p className="text-5xl text-lime-400 font-semibold">
          Welcome to landing page
        </p>
        <br />
        <button className="bg-cyan-500 shadow-lg shadow-cyan-500/60 border-cyan-500 border-4 rounded-lg h-10 w-25">
          Subscribe
        </button>
      </div>
